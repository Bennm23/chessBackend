...
//   packing to an 8-bit transformed vector (width L1).
...
pub struct FeatureTransformer {
    pub biases: Vec<i16>,                  // L1
    pub weights: Vec<i16>,                 // L1 * INPUT_DIM
...
impl FeatureTransformer {
    pub fn read_parameters(r: &mut impl Read) -> io::Result<Self> {
        ...
        let biases = read_leb128_i16(r, L1)?;
        let weights = read_leb128_i16(r, L1 * INPUT_DIM)?;
