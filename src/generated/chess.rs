...
pub struct Board {
    ...
    pub turnCount: i32,
    // @@protoc_insertion_point(field:Board.black_long_castle)
    pub black_long_castle: bool,
    // @@protoc_insertion_point(field:Board.black_castle)
    pub black_castle: bool,
    // @@protoc_insertion_point(field:Board.white_long_castle)
    pub white_long_castle: bool,
    // @@protoc_insertion_point(field:Board.white_castle)
...
impl Board {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "black_long_castle",
            |m: &Board| { &m.black_long_castle },
            |m: &mut Board| { &mut m.black_long_castle },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "black_castle",
            |m: &Board| { &m.black_castle },
            |m: &mut Board| { &mut m.black_castle },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "white_long_castle",
            |m: &Board| { &m.white_long_castle },
            |m: &mut Board| { &mut m.white_long_castle },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "white_castle",
            |m: &Board| { &m.white_castle },
            |m: &mut Board| { &mut m.white_castle },
        ));
...
impl ::protobuf::Message for Board {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                40 => {
                    self.black_long_castle = is.read_bool()?;
                },
                48 => {
                    self.black_castle = is.read_bool()?;
                },
                56 => {
                    self.white_long_castle = is.read_bool()?;
                },
                64 => {
                    self.white_castle = is.read_bool()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.black_long_castle != false {
            my_size += 1 + 1;
        }
        if self.black_castle != false {
            my_size += 1 + 1;
        }
        if self.white_long_castle != false {
            my_size += 1 + 1;
        }
        if self.white_castle != false {
            my_size += 1 + 1;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.black_long_castle != false {
            os.write_bool(5, self.black_long_castle)?;
        }
        if self.black_castle != false {
            os.write_bool(6, self.black_castle)?;
        }
        if self.white_long_castle != false {
            os.write_bool(7, self.white_long_castle)?;
        }
        if self.white_castle != false {
            os.write_bool(8, self.white_castle)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
pub struct GetValidMoves {
    ...
    // @@protoc_insertion_point(field:GetValidMoves.fen_string)
...
impl GetValidMoves {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "fen_string",
            |m: &GetValidMoves| { &m.fen_string },
            |m: &mut GetValidMoves| { &mut m.fen_string },
        ));
...
impl ::protobuf::Message for GetValidMoves {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.fen_string.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.fen_string);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.fen_string.is_empty() {
            os.write_string(2, &self.fen_string)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
pub struct ValidMovesResponse {
    ...
    // @@protoc_insertion_point(field:ValidMovesResponse.request_piece)
    pub request_piece: ::protobuf::MessageField<ProtoPiece>,
    // special fields
...
impl ValidMovesResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, ProtoPiece>(
            "request_piece",
            |m: &ValidMovesResponse| { &m.request_piece },
            |m: &mut ValidMovesResponse| { &mut m.request_piece },
        ));
...
impl ::protobuf::Message for ValidMovesResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.request_piece)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.request_piece.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn default_instance() -> &'static ValidMovesResponse {
        static instance: ValidMovesResponse = ValidMovesResponse {
            ...
            request_piece: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub struct Move {
    ...
    // @@protoc_insertion_point(field:Move.secondary_end_pos)
    pub secondary_end_pos: ::protobuf::MessageField<Position>,
    // special fields
...
impl Move {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, Position>(
            "secondary_end_pos",
            |m: &Move| { &m.secondary_end_pos },
            |m: &mut Move| { &mut m.secondary_end_pos },
        ));
...
impl ::protobuf::Message for Move {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.secondary_end_pos)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.secondary_end_pos.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn default_instance() -> &'static Move {
        static instance: Move = Move {
            ...
            secondary_end_pos: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub struct FindBestResponse {
    ...
    // @@protoc_insertion_point(field:FindBestResponse.promoted_piece)
    pub promoted_piece: ::protobuf::EnumOrUnknown<PieceType>,
    // special fields
...
impl FindBestResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "promoted_piece",
            |m: &FindBestResponse| { &m.promoted_piece },
            |m: &mut FindBestResponse| { &mut m.promoted_piece },
        ));
...
impl ::protobuf::Message for FindBestResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                24 => {
                    self.promoted_piece = is.read_enum_or_unknown()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.promoted_piece != ::protobuf::EnumOrUnknown::new(PieceType::NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.promoted_piece.value());
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.promoted_piece != ::protobuf::EnumOrUnknown::new(PieceType::NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.promoted_piece))?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn clear(&mut self) {
        self.from_pos.clear();
        self.end_pos.clear();
        self.promoted_piece = ::protobuf::EnumOrUnknown::new(PieceType::NONE);
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static FindBestResponse {
        static instance: FindBestResponse = FindBestResponse {
            ...
            promoted_piece: ::protobuf::EnumOrUnknown::from_i32(0),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::Enum for PieceColor {
    ...
    fn from_str(str: &str) -> ::std::option::Option<PieceColor> {
        match str {
            "BLACK" => ::std::option::Option::Some(PieceColor::BLACK),
            "WHITE" => ::std::option::Option::Some(PieceColor::WHITE),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for PieceType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<PieceType> {
        match str {
            "NONE" => ::std::option::Option::Some(PieceType::NONE),
            "PAWN" => ::std::option::Option::Some(PieceType::PAWN),
            "KNIGHT" => ::std::option::Option::Some(PieceType::KNIGHT),
            "BISHOP" => ::std::option::Option::Some(PieceType::BISHOP),
            "ROOK" => ::std::option::Option::Some(PieceType::ROOK),
            "QUEEN" => ::std::option::Option::Some(PieceType::QUEEN),
            "KING" => ::std::option::Option::Some(PieceType::KING),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nCount\x12*\n\x11black_long_castle\x18\x05\x20\x01(\x08R\x0fblackLongCas\
    tle\x12!\n\x0cblack_castle\x18\x06\x20\x01(\x08R\x0bblackCastle\x12*\n\
    \x11white_long_castle\x18\x07\x20\x01(\x08R\x0fwhiteLongCastle\x12!\n\
    \x0cwhite_castle\x18\x08\x20\x01(\x08R\x0bwhiteCastle\"_\n\rGetValidMove\
    s\x12/\n\rpiece_to_move\x18\x01\x20\x01(\x0b2\x0b.ProtoPieceR\x0bpieceTo\
    Move\x12\x1d\n\nfen_string\x18\x02\x20\x01(\tR\tfenString\"g\n\x12ValidM\
    ovesResponse\x12\x1f\n\x05moves\x18\x01\x20\x03(\x0b2\t.PositionR\x05mov\
    es\x120\n\rrequest_piece\x18\x02\x20\x01(\x0b2\x0b.ProtoPieceR\x0creques\
    tPiece\"P\n\x0bGetBestMove\x12\x1c\n\x05board\x18\x01\x20\x01(\x0b2\x06.\
    BoardR\x05board\x12#\n\x06player\x18\x02\x20\x01(\x0e2\x0b.PieceColorR\
    \x06player\"\x9c\x01\n\x04Move\x12/\n\rpiece_to_move\x18\x01\x20\x01(\
    ...
    \x02\x02\x01\x01\x12\x03\"\x0f\x1d\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\
    \x03\"\x20!\n-\n\x04\x04\x02\x02\x02\x12\x03#\x04\x18\"\x20\x20repeated\
    \x20Move\x20valid_moves\x20=\x204;\n\n\x0c\n\x05\x04\x02\x02\x02\x05\x12\
    ...
    \x02\0\x12\x032\x04\x20\n\x0c\n\x05\x04\x04\x02\0\x04\x12\x032\x04\x0c\n\
    \x0c\n\x05\x04\x04\x02\0\x06\x12\x032\r\x15\n\x0c\n\x05\x04\x04\x02\0\
    \x01\x12\x032\x16\x1b\n\x0c\n\x05\x04\x04\x02\0\x03\x12\