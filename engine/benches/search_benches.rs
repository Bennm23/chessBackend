...
fn bench_engine_search(c: &mut Criterion) {
    c.bench_function("Search Default Depth 5", |b| {
        bench_search_default(b, 5);
    });
    c.bench_function("Search Default Depth 6", |b| {
        bench_search_default(b, 6);
    });
    c.bench_function("Search Default Depth 7", |b| {
        bench_search_default(b, 7);
    });

    c.bench_function("Search Kiwipete Depth 5", |b| {
        bench_search_kiwipete(b, 5);
    });
    c.bench_function("Search Kiwipete Depth 6", |b| {
        bench_search_kiwipete(b, 6);
    });
    c.bench_function("Search Kiwipete Depth 7", |b| {
        bench_search_kiwipete(b, 7);
    });
    // c.bench_function(
